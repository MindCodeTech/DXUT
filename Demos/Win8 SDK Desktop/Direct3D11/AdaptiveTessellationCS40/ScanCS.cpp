...
HRESULT CScanCS::OnD3D11CreateDevice( ID3D11Device* pd3dDevice )
{
    ...
    V_RETURN( CompileShaderFromFile( L"\\..\\Media\\Shaders\\ScanCS.hlsl", nullptr, "CSScanInBucket", "cs_4_0", &pBlobCS ) );
    ...
    V_RETURN( CompileShaderFromFile( L"\\..\\Media\\Shaders\\ScanCS.hlsl", nullptr, "CSScanBucketResult", "cs_4_0", &pBlobCS ) );
    ...
    V_RETURN( CompileShaderFromFile( L"\\..\\Media\\Shaders\\ScanCS.hlsl", nullptr, "CSScanAddBucketResult", "cs_4_0", &pBlobCS ) );
