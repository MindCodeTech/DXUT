                                                   ...
                                                   ID3D11ComputeShader** pNumVerticesIndicesCS, ID3D11ComputeShader** pTessVerticesCS, ID3D11ComputeShader** pTessIndicesCS )
{
    ...
    V_RETURN( CompileShaderFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_NumVerticesIndicesCS.hlsl", define, "CSNumVerticesIndices", "cs_4_0", &pBlobCS ) );
    ...
    V_RETURN( CompileShaderFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_TessellateVerticesCS.hlsl", define, "CSTessellationVertices", "cs_4_0", &pBlobCS ) );
    ...
    V_RETURN( CompileShaderFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_TessellateIndicesCS.hlsl", define, "CSTessellationIndices", "cs_4_0", &pBlobCS ) );
                                   ...
                                   ID3D11Buffer* pBaseVB )
{
    ...
    if ( s_pEdgeFactorCS == nullptr )
    {
        SetPartitioningMode( PARTITIONING_MODE_FRACTIONAL_EVEN );
        
        ID3DBlob* pBlobCS = nullptr;
        V_RETURN( CompileShaderFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_EdgeFactorCS.hlsl", nullptr, "CSEdgeFactor", "cs_4_0", &pBlobCS ) );
        ...
        V_RETURN( CompileShaderFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_ScatterIDCS.hlsl", nullptr, "CSScatterVertexTriIDIndexID", "cs_4_0", &pBlobCS ) );
        ...
        V_RETURN( CompileShaderFromFile( L"\\..\\Media\\Shaders\\TessellatorCS40_ScatterIDCS.hlsl", nullptr, "CSScatterIndexTriIDIndexID", "cs_4_0", &pBlobCS ) );
...
void CTessellator::PerEdgeTessellation( XMMATRIX* matWVP,
                                        ...
                                        DWORD* num_tessed_vertices, DWORD* num_tessed_indices )
{
    ...
    {
        if ( m_pScatterVertexBuf == nullptr || m_nCachedTessedVertices < *num_tessed_vertices )
        {
            SAFE_RELEASE( m_pScatterVertexBuf );
            SAFE_RELEASE( m_pScatterVertexBufSRV );
            SAFE_RELEASE( m_pScatterVertexBufUAV );
        ...
        if ( m_pScatterIndexBuf == nullptr || m_nCachedTessedIndices < *num_tessed_indices )
        {
            SAFE_RELEASE( m_pScatterIndexBuf );
            SAFE_RELEASE( m_pScatterIndexBufSRV );
            SAFE_RELEASE( m_pScatterIndexBufUAV );
