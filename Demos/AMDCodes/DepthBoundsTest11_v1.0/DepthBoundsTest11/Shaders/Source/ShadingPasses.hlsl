...
float4 PS_PointLight( PS_QUAD_INPUT i ) : SV_TARGET
{
	...
	// Performance optimization: discard any pixel not contributing any light by discarding if its contribution is 0
    // This makes a significant performance difference!
    if (fDistanceFallOff == 0) 
	{
