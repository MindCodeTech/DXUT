...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT WINAPI CWaveFile::Open(LPWSTR strFileName, WAVEFORMATEX* pwfx, DWORD dwFlags)
{
	HRESULT hr;
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT WINAPI CWaveFile::OpenFromMemory(BYTE* pbData, ULONG ulDataSize,
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT WINAPI CWaveFile::ReadMMIO()
{
...
//-----------------------------------------------------------------------------
DXUTAPI DWORD WINAPI CWaveFile::GetSize()
{
	return m_dwSize;
}
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT WINAPI CWaveFile::ResetFile()
{
	if (m_bIsReadingFromMemory)
	{
		m_pbDataCur = m_pbData;
...
//       Reset() is called.
//-----------------------------------------------------------------------------
DXUTAPI HRESULT WINAPI CWaveFile::Read(BYTE* pBuffer, DWORD dwSizeToRead, DWORD* pdwSizeRead)
{
	if (m_bIsReadingFromMemory)
	{
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT WINAPI CWaveFile::Close()
{
	if (m_dwFlags == WAVEFILE_READ)
	{
		if (m_hmmio != nullptr)
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT WINAPI CWaveFile::WriteMMIO(WAVEFORMATEX* pwfxDest)
{
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT WINAPI CWaveFile::Write(UINT nSizeToWrite, BYTE* pbSrcData, UINT* pnSizeWrote)
{
	UINT cT;
