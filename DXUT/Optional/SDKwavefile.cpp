...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT CWaveFile::Open( LPWSTR strFileName, WAVEFORMATEX* pwfx, DWORD dwFlags )
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT CWaveFile::OpenFromMemory( BYTE* pbData, ULONG ulDataSize,
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT CWaveFile::ReadMMIO()
{
...
//-----------------------------------------------------------------------------
DXUTAPI DWORD CWaveFile::GetSize()
{
    return m_dwSize;
}
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT CWaveFile::ResetFile()
{
    if( m_bIsReadingFromMemory )
    {
        m_pbDataCur = m_pbData;
...
//       Reset() is called.
//-----------------------------------------------------------------------------
DXUTAPI HRESULT CWaveFile::Read( BYTE* pBuffer, DWORD dwSizeToRead, DWORD* pdwSizeRead )
{
    if( m_bIsReadingFromMemory )
    {
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT CWaveFile::Close()
{
    if( m_dwFlags == WAVEFILE_READ )
    {
        if ( m_hmmio != nullptr )
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT CWaveFile::WriteMMIO( WAVEFORMATEX* pwfxDest )
{
...
//-----------------------------------------------------------------------------
DXUTAPI HRESULT CWaveFile::Write( UINT nSizeToWrite, BYTE* pbSrcData, UINT* pnSizeWrote )
{
    UINT cT;
