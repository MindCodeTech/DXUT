                                   ...
                                   ID3D11Buffer* pBaseVB )
{
    ...
    if ( s_pEdgeFactorCS == nullptr )
    {
        ...
        ID3DBlob* pBlobCS = nullptr;
        V_RETURN( CompileShaderFromFile( L"TessellatorCS40_EdgeFactorCS.hlsl", nullptr, "CSEdgeFactor", "cs_4_0", &pBlobCS ) );
        ...
        V_RETURN( CompileShaderFromFile( L"TessellatorCS40_ScatterIDCS.hlsl", nullptr, "CSScatterVertexTriIDIndexID", "cs_4_0", &pBlobCS ) );
        ...
        V_RETURN( CompileShaderFromFile( L"TessellatorCS40_ScatterIDCS.hlsl", nullptr, "CSScatterIndexTriIDIndexID", "cs_4_0", &pBlobCS ) );
