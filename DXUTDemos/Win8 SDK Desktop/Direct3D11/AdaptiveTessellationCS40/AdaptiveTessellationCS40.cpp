...
using IMalloc::GetSize;

/*
using CDXUTListBox::GetSize;
*/
                                     ...
                                     void* pUserContext )
{
	...
	static const XMVECTORF32 s_vecEye = { 0.0f, -300.0f, 0.0f };
	static const XMVECTORF32 s_vecAt = {10.0f, 20.0f, 0.0f };
                                 ...
                                 float fElapsedTime, void* pUserContext )
{
    ...
    if ( g_bShowTessellated )
    {
        ...
        if ( num_tessed_vertices > 0 && num_tessed_indices > 0 )
        {
            ...
            XMMATRIX* pMat = ( XMMATRIX* )MappedResource.pData;  
